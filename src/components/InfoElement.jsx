const InfoSection = ({ imageSrc, title, description, buttonText, buttonColor, imageRight = false, linkHref }) => {
    return (
        <div
...
                <a
                    href={linkHref}
                    className={`bg-celeste text-white px-10 py-2 rounded-lg hover:bg-black border-celeste border-2 transition-colors ${
